  ...
  return (
    <div className="min-h-screen bg-page text-ink">
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <p className="text-sm text-ink-faint mb-10">Last updated: 5 March 2026</p>
        ...
        <div className="space-y-8 text-ink-muted">
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-3">2. How We Use Information</h2>
            <ul className="list-disc list-inside space-y-1 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-3">3. Data Storage</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-3">4. Analytics</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-3">6. Revoking Access</h2>
          ...
          <section>
            ...
            <p className="text-sm">
              <a href="mailto:aparnacs008@gmail.com" className="text-accent hover:underline">
