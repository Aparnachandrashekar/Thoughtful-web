      ...
      <main className="flex-1 px-5 sm:px-8 md:px-14 py-8 sm:py-10 md:py-14 min-w-0">
        <div className="max-w-2xl mx-auto">
              ...
              {googleReady && !signedIn && (
                <button
                  ...
                  className="flex items-center gap-2 px-5 py-2.5 bg-white
                             ...
                             hover:border-terra/30 hover:shadow-[0_4px_16px_rgba(212,117,106,0.15)]
          ...
          {signedIn ? (
            ...
            <div className="text-center py-14 animate-fade-up delay-200">
              <p className="text-terra/40 text-sm font-light">
                Sign in with Google to start creating reminders
              </p>
            </div>
          )}
      </div>
